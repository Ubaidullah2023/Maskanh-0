...
type CreateDescriptionScreenRouteProp = RouteProp<RootStackParamList, 'CreateDescription'>;
...
export default function CreateDescriptionScreen() {
  ...
  const handleNext = () => {
    if (description.trim()) {
      navigation.navigate('BookingSettings', {
        ...route.params,
      ...
      <View style={styles.content}>
        ...
        <View style={styles.inputContainer}>
          ...
          <Text style={styles.characterCount}>
            {MAX_CHARACTERS - description.length} characters available
          </Text>
        </View>
      </View>
